...
with st.sidebar:
    st.markdown(f"""
<div style="background-color: #f8f9fa; border: 2px solid #ef5f17; border-radius: 10px; padding: 1rem; margin-top: 1rem; font-size: 14px; font-family: Segoe UI, sans-serif;">
    <h4 style="color:#ef5f17; margin:0;">&#128188; {centro_actual}</h4>  <!-- Emoji 💼 -->
